...
public class Dev_Usecase_IntegrationTests {
    ...
    public static AssumingConnection assumingConnectionSurfer =
            new AssumingConnection(new ConnectionChecker(HelperTestService.getSurferUrl()));
//    @ClassRule
//    public static AssumingConnection assumingConnectionInvoke =
//            new AssumingConnection(new ConnectionChecker(HelperTestService.getInvokeUrl()));
