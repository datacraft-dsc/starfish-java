...
public interface Invokable {
	...
	/**
	 * Invokes the specified operation on this agent. If the invoke is successfully
	 * launched, will return a Job instance that can be used to access the result,
	...
	/**
	 * Gets the parameter specification for this Invokable service given the
	 * specified operation
	 * 
	 * @param op The operation for which to obtain the parameter specification
	 *
	 * @throws UnsupportedOperationException if this service cannot support the
	 *             given operation
