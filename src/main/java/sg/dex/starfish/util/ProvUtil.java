...
public class ProvUtil {
     ...
     * @return Map
     */
    private static Map<String, Object> createEntities(Map<String, Object>... ent) {
    ...
    /**
     * Create default provenance metadata for publishing an asset. This create a
     * random activity ID for tracking the provenance
     *
    ...
    /**
     * Create default provenance metadata for publishing an asset created using
     * invoke.
     *
     * @param actId             the activity Id
     * @param agentId           the agent identifier
